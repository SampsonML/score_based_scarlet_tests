...
def main(
    ...
    for step, data in zip(
        ...
        if (step % print_every) == 0 or step == num_steps - 1:
            ...
            total_size = 0
            # save the model
            fn = SAVE_DIR + '/hsc_model_step_' +str(step) + '_res_' +str(args.size)+ '.eqx'
    ...
    plt.axis("off")
    plt.tight_layout()
    filename = 'galaxy_hsc_res' + str(args.size) + '.png'
    plt.savefig(filename,facecolor='black', transparent=False ,dpi = 250)
    filename = 'galaxy_hsc_res' + str(args.size) + '.pdf'
    plt.savefig(filename,facecolor='black', transparent=False ,dpi = 250)   
    plt.show()
    ...
    filename = 'galaxy_hsc_res' + str(args.size) + '.png'
    plt.savefig(filename,facecolor='black', transparent=False ,dpi = 250)
    filename = 'galaxy_hsc_exp_res' + str(args.size) + '.pdf'
    plt.savefig(filename,facecolor='black', transparent=False ,dpi = 250)   
    plt.show()
